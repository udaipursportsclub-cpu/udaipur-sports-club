      ...
      <div className="w-full max-w-md">
        ...
        {alreadyHost ? (
          <div className="text-center">
            ...
            <a
              href="/events/new"
              className="inline-block bg-amber-500 hover:bg-amber-400 text-white font-bold text-sm px-8 py-3 rounded-full transition-colors"
            >
              Create an Event →
            </a>
          </div>
          ...
          <div>
            ...
            <div className="text-center mb-10">
              <span className="inline-block text-xs font-bold tracking-[0.2em] uppercase text-amber-600 bg-amber-50 border border-amber-200 px-4 py-1 rounded-full mb-6">
                Host Challenge
              </span>
